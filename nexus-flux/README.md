...
Both engines include reduced CPU canvas implementations. Missing or failed WebGPU initialization must fall back rather than produce a blank page.
...
The regression suite checks deterministic behavior, phone grid limits, all four WGSL modules, memory budgets, frame ordering, field mathematics, adaptive quality, rewind state, parameter search and AI-readable engine contracts.
